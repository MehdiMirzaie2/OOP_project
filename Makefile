...
TEST_DEPENDENCIES := test.o Game.o map.o User.o Entity.o Unit.o Director.o Deck.o UnitBuilder.o RangerBuilder.o BattleWindow.o CustomizeWindow.o MainMenu.o Attack.o 
