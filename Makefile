...
TEST_DEPENDENCIES := test.o Game.o map.o User.o Entity.o Unit.o Director.o Deck.o UnitBuilder.o BattleWindow.o CustomizeWindow.o MainMenu.o Attack.o Elixir.o Drawable.o 
