...
{
    std::shared_ptr<Unit> unit = std::make_shared<Unit>(Unit(damage,speed, location,radius_of_attack, cost, HP, textureIdle, textureAttacking, projectileTextureName, alliance));
    return unit;
}